...
const HeadphoneNews = () => {
  ...
  return (
    <Box>
      <div className="headphonesnews__container">
        <div className="headphonesnews__title">
        ...
        >
          <SwiperSlide>
            <div className="headphonesnews__wrapper">
