        ...
        >
          ...
          <SwiperSlide>
            <div className="slide__item">
              <div className="banner">
                <img
                  src="https://jannah.tielabs.com/tech/wp-content/uploads/sites/10/2016/12/pexels-photo-390x220.jpg"
                  alt=""
                />
              </div>
              <div className="content">
          ...
          <SwiperSlide>
            <div className="slide__item">
              <div className="banner">
                <img
                  src="https://jannah.tielabs.com/tech/wp-content/uploads/sites/10/2016/12/photo-1480365501497-199581be0e66-390x220.jpeg"
                  alt=""
                />
              </div>
              <div className="content">
          ...
          <SwiperSlide>
            <div className="slide__item">
              <div className="banner">
                <img
                  src="https://jannah.tielabs.com/tech/wp-content/uploads/sites/10/2016/12/YAR_MY15_0009_V003-390x220.jpg"
                  alt=""
                />
              </div>
              <div className="content">
